...
const Products: FC<ProductsProps> = () => {
  const some = useSelector((state: RootState) => state.app.appCategories);
  ...
  return (
    <div className={styles.Products}>
      ...
      <CatalogCard
        ...
        list={daggerCatalog}
      >
        <img className={styles.img} src={dagger} alt="Среднеклинковое оружие" />
      </CatalogCard>
      <CatalogCard
        route={'/sword'}
        ...
        list={swordCatalog}
      >
        <img className={styles.img} src={sword} alt="Длинноклинковое оружие" />
      </CatalogCard>
      <CatalogCard
        route={'/souvenir'}
      ...
      <CatalogCard
        ...
        list={relatedCatalog}
      >
        <img className={styles.img} src={related} alt="Сопутствующие товары" />
      </CatalogCard>
      <CatalogCard
        route={'/workshop'}
